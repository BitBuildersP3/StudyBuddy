...
export class VotesComponent implements OnInit {
  ...
  @Input() votes: number | undefined | null;
  @Input() userVotes: number | undefined | null;
  @Input() TotalVotes: number | undefined | null;
  @Input() totalUsers: number | undefined | null;

  @Output() votesChanges = new EventEmitter<number>();
  constructor() {
  ...
  ratingChanged(vote: any) {
    this.userVotes = vote.detail;
    this.votesChanges.emit(vote.detail);
  }
}
